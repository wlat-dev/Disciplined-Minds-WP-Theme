		...
		<nav class="container navigation post-navigation">
			...
			<div class="row nav-links justify-content-center">
				...
				if ( get_previous_post_link() ) {
					previous_post_link( '<span class="nav-previous badge badge-primary badge-pill shadow mr-3 p-2">%link</span>', _x( '<i class="fa fa-angle-left"></i>&nbsp;%title', 'Previous post link', 'understrap' ) );
				}
				if ( get_next_post_link() ) {
					next_post_link( '<span class="nav-previous badge badge-primary badge-pill shadow p-2">%link</span>', _x( '%title&nbsp;<i class="fa fa-angle-right"></i>', 'Next post link', 'understrap' ) );
				}
				?>
			</div><!-- .nav-links -->
		</nav><!-- .navigation -->
